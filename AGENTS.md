# AGENTS.md — AI 城市漫游产品 · Coding Agent 总约束

> 这是 coding agent（Codex / Cursor 等）进入本仓库后**首先必须阅读**的文件。
...
```
.
├── AGENTS.md / .cursorrules / README.md / Makefile / .gitignore / .env.example
...
4. **质量优先于数量**：城市内容只做 12 个精选城市，每城 1~2 地标 / 1~2 美食 / 1 人物。
